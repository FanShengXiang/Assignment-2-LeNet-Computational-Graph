...
class Sigmoid_Swish():
    ...
    def _backward(self, dout):
        X,Z = self.cache
        dout = np.clip(dout, -5000, 5000)
        sigmoid_x = self.sigmoid(dout)
        return sigmoid_x + dout * sigmoid_x * (1 - sigmoid_x)
...
class LeNet5_Modified(Net):
    # LeNet5

    def __init__(self):
        self.conv1 = Conv(1, 6, 3)
        self.Sigmoid1 = Sigmoid_Swish()
        self.pool1 = MaxPool(2,2)
        self.conv2 = Conv(6, 16, 3)
        self.Sigmoid2 = Sigmoid_Swish()
        self.pool2 = MaxPool(2,2)
        self.FC1 = FC(16*4*4, 120)
        self.Sigmoid3 = Sigmoid_Swish()
        self.FC2 = FC(120, 84)
        self.Sigmoid4 = Sigmoid_Swish()
        self.FC3 = FC(84, 50)
        self.Softmax = Softmax()
        self.Sigmoid = Sigmoid()
        self.p2_shape = None
...
val_images = output_tensor(InputLayer(input_shape=(28, 28, 3)), "valOutput.npy", valPaths)
